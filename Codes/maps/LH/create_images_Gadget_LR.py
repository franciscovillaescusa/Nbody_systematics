...
#################################### INPUT ##########################################
# data parameters
root_in      = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/Sims'
...
for i in numbers:
    ...
    snapshot = '%s/%s/%d/snap_%03d.hdf5'%(root_in,sim,i,snapnum)
    ...
    fout = '%s/maps_%s/Images_M_%s_%s_%d_z=%.2f.npy'\
           %(root_out,sim,sim,prefix,i,redshift)   
