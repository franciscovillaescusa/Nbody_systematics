...
#################################### INPUT ##########################################
# data parameters
root_in      = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/Sims/Gadget_resolution_test'
...
snapshot = '%s/%s/snap_%03d.hdf5'%(root_in,sim,snapnum)
...
fout = '%s/maps_%s/Images_M_%s_test_z=%.2f.npy'%(root_out,sim,sim,redshift)   
