...
#################################### INPUT ##########################################
# data parameters
root_in      = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/Sims/Gadget_NCV'
root_out     = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/maps_Gadget_NCV'
prefix       = 'LH'
sim          = 'Gadget_NCV'
realizations = 50
