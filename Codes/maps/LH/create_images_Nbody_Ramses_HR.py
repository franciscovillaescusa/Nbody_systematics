...
#################################### INPUT ##########################################
# data parameters
root_in      = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/Sims/Ramses_HR'
root_out     = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/maps_Ramses_HR'
prefix       = 'LH'
sim          = 'Ramses'
realizations = 10
snapnums     = [6]
