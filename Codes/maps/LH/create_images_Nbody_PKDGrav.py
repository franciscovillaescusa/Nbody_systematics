...
# This routine reads a tipsy file
...
#################################### INPUT ##########################################
# data parameters
root_in      = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/Sims/PKDGrav'
root_out     = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/maps_PKDGrav'
prefix       = 'LH'
sim          = 'PKDGrav'
realizations = 50
...
for i in numbers:
    ...
    BoxSize = 25.0 #Mpc/h
    redshift = 0.0
    snapshot = '%s/%d/run.00100'%(root_in,i)
