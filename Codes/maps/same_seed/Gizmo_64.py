...
#################################### INPUT ##########################################
# data parameters
snapshot     = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/Sims/same_seed/Gizmo_64/snap_005.hdf5'
fout         = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/same_seed/Images_M_Gizmo_64_fiducial_z=0.00.npy'
