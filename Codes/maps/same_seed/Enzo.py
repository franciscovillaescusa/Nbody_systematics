...
#################################### INPUT ##########################################
# data parameters
#snapshot     = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/Sims/same_seed/Enzo/small_courant/RD0003/RD0003'
...
vel     = ad[('nbody','particle_velocity')].in_units('km/s').d    #km/s
M       = ad[('nbody','particle_mass')].in_units('Msun/h').d      #Msun/h
...
print('%.3e < M < %.3e'%(np.min(M),        np.max(M)))
