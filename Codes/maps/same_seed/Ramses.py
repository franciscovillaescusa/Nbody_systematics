...
#################################### INPUT ##########################################
# data parameters
#snapshot     = '/mnt/ceph/users/camels/Sims/Ramses/dmo/output_00035'
#fout         = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/comparison/Images_M_Ramses_fiducial_z=0.00.npy'
snapshot     = '/mnt/ceph/users/camels/Sims/Ramses/dmo_HR/output_00035'
fout         = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/comparison/Images_M_Ramses_HR_fiducial_z=0.00.npy'
