...
#################################### INPUT ##########################################
# data parameters
snapshot     = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/Sims/same_seed/PKDGrav_HR/run.00100'
fout         = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/same_seed/Images_M_PKDGrav_HR_fiducial_z=0.00.npy'
