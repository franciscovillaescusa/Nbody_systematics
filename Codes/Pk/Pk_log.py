...
fout1 = 'Pk_log_Gadget.txt'

snap2 = '%s/Ramses/output_00035'%root
fout2 = 'Pk_log_Ramses.txt'

snap3 = '%s/Ramses_HR/output_00035'%root
fout3 = 'Pk_log_Ramses_HR.txt'

snap4 = '%s/Abacus/z0.000.asdf'%root
fout4 = 'Pk_log_Abacus.txt'

snap5 = '%s/PKDGrav/run.00100'%root
fout5 = 'Pk_log_PKDGrav.txt'

snap6 = '%s/CUBEP3M/nc1024_pp_range2.npy'%root
fout6 = 'Pk_log_cube_nc1024_pp2.txt'

snap7 = '%s/PKDGrav_HR/run.00100'%root
fout7 = 'Pk_log_PKDGrav_HR.txt'

snap8 = '%s/Gadget_HR/snap_005.hdf5'%root
fout8 = 'Pk_log_Gadget_HR.txt'

snap9 = '%s/Gizmo/snap_005.hdf5'%root
fout9 = 'Pk_log_Gizmo.txt'

snap10 = '%s/Enzo/amr/RD0003/RD0003'%root
fout10 = 'Pk_log_Enzo3.txt'

snap11 = '%s/Abacus_HR/z0.000.asdf'%root
fout11 = 'Pk_log_Abacus_HR.txt'
