...
arch        = 'o3'
suffix      = 'o3_smoothing_0'
channels    = 1

# optuna parameters
storage    = 'sqlite:////mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/databases/Gadget_Nbody_plus_Hydro_LH_o3_smoothing_0.db'
...
sim         = 'Ramses'
redshift    = 0.0
root_data   = '/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/maps_%s'%sim
f_maps      = ['%s/Images_M_%s_LH_z=%.2f.npy'%(root_data,sim,redshift)]
f_params    = '%s/params_%s.txt'%(root_data,sim)
#f_maps      = ['/mnt/ceph/users/camels/PUBLIC_RELEASE/CMD/2D_maps/data/Maps_Mtot_Nbody_IllustrisTNG_LH_z=0.00.npy']
#f_params    = '/mnt/ceph/users/camels/PUBLIC_RELEASE/CMD/2D_maps/data/params_Nbody_IllustrisTNG.txt'
f_maps_norm = ['/mnt/ceph/users/fvillaescusa/Nbody_systematics/data/maps/maps_Gadget_Nbody+Hydro/Maps_Mtot_IllustrisTNG_Nbody+Hydro_LH_z=0.00.npy']

# results
fresults = 'Trained_Gadget_Nbody+Hydro_tested_%s_z=%.2f.txt'%(sim,redshift)
#######################################################################################
