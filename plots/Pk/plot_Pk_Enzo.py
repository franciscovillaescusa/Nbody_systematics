...
p1,=ax1.plot(data2[:,0],data1[:,1]/data1[:,1],linestyle='-',marker='None',c='k')
p2,=ax1.plot(data2[:,0],data2[:,1]/data1[:,1],linestyle='-',marker='None',c='b')
p3,=ax1.plot(data2[:,0],data3[:,1]/data1[:,1],linestyle='-',marker='None',c='r')
p4,=ax1.plot(data2[:,0],data4[:,1]/data1[:,1],linestyle='-',marker='None',c='g')
...
ax1.plot([32,32],[0.8,1.2],linestyle='--',marker='None',c='k')



#place a label in the plot
ax1.text(0.85,0.7, r"$z=0$", fontsize=18, color='k',transform=ax1.transAxes)


#legend
ax1.legend([p2,p3,p4,p5,p6,p7],
           ["No AMR", "No AMR small courant",
            "AMR 5", "AMR 14", 
            "AMR 14 small courtant", "Ramses"],
           loc=3,prop={'size':10},ncol=1,frameon=True)
