...
f3 = '%s/Trained_Gadget_tested_Abacus_z=0.00.txt'%root
f4 = '%s/Trained_Gadget_tested_Ramses_z=0.00.txt'%root
f5 = '%s/Trained_Gadget_tested_Ramses_HR_z=0.00.txt'%root
f6 = '%s/Trained_Gadget_tested_CUBEP3M_z=0.00.txt'%root
...
p2=ax1.errorbar(x+elems*1+1,data2[indexes,7],yerr=data2[indexes,13],lw=1,fmt='o',ms=2,
                elinewidth=1,capsize=5,linestyle='None') 
p3=ax1.errorbar(x+elems*2+2,data3[indexes,7],yerr=data3[indexes,13],lw=1,fmt='o',ms=2,
                elinewidth=1,capsize=5,linestyle='None') 
p4=ax1.errorbar(x+elems*3+3,data4[indexes,7],yerr=data4[indexes,13],lw=1,fmt='o',ms=2,
                elinewidth=1,capsize=5,linestyle='None') 
p5=ax1.errorbar(x+elems*4+4,data5[indexes,7],yerr=data5[indexes,13],lw=1,fmt='o',ms=2,
                elinewidth=1,capsize=5,linestyle='None') 
p6=ax1.errorbar(x+elems*5+5,data6[indexes,7],yerr=data6[indexes,13],lw=1,fmt='o',ms=2,
                elinewidth=1,capsize=5,linestyle='None') 


ax1.plot([-10,200],[0.834,0.834], lw=1, c='k')
...
ax1.legend([p1,p2,p3,p4,p5,p6],
           [r"${\rm Gadget}$",
            ...
            r"${\rm Ramses\,\,HR}$",
            r"${\rm CUBEP3M}$"],
           loc=0,prop={'size':16},ncol=3,frameon=True)
